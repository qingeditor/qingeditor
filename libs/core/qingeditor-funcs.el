...
(defun qingeditor/warning (msg &rest args)
...
(defun qingeditor/increment-error-count ()
  "增加全局错误计数器。"
  (if qingeditor/private-vars/error-count
      (setq qingeditor/private-vars/error-count
            (1+ qingeditor/private-vars/error-count))
    (setq qingeditor/private-vars/error-count 1)))
