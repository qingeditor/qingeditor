...
(defun qingeditor/editor-ui-visual/init-adaptive-wrap ()
...
`auto-highlight-symbol'."
        (interactive)
        (setq qingeditor/editor-ui-visual/ahs-searching-forward t)
...
`auto-highlight-symbol'."
        (interactive)
        (setq qingeditor/editor-ui-visual/ahs-searching-forward nil)
...
`auto-highlight-symbol'."
        (interactive)
        (qingeditor/editor-ui-visual/quick-ahs-move t))

      (defun qing-quick-ahs-backward ()
        "Go to the previous occurrence of symbol under point with
`auto-highlight-symbol'."
        (interactive)
        (qingeditor/editor-ui-visual/quick-ahs-move nil))

      (defun qingeditor/editor-ui-visual/quick-ahs-move (forward)
        "Go t the next occurrence of symbol under point with
`auto-highlight-symbol'."
        (if (eq forward qingeditor/editor-ui-visual/ahs-searching-forward)
            (progn
              (qingeditor/editor-ui-visual/ahs-highlight-now-wrapper)
              (qing-symbol-highlight-transient-state/body)
              (ahs-forward))
      ...
      (defun qing-symbol-highlight ()
        ...
        (interactive)
        (qingeditor/editor-ui-visual/ahs-highlight-now-wrapper)
        (setq qingeditor/editor-ui-visual/last-ahs-highlight-p (ahs-highlight-p))
        (qing-symbol-highlight-transient-state/body))

      (defun qingeditor/editor-ui-visual/ahs-ms-on-exit ()
        ;; Restore user search direction state as ahs has exitted in a state
        ;; good for <C-s>, but not for 'n' and 'N'"
        (setq isearch-forward qingeditor/editor-ui-visual/ahs-searching-forward))
      ...
      (dolist (sym '(ahs-forward
                     ...
                     ahs-back-to-start
                     ahs-change-range))
        (let* ((advice (intern (format "qingeditor/editor-ui-visual/%s-adv" (symbol-name sym)))))
      ...
      (defun qingeditor/editor-ui-visual/symbol-highlight-doc ()
        (let* ((i 0)
      ...
      ;; transient state
      (defun qingeditor/editor-ui-visual/symbol-highlight-ts-doc ()
        (qingeditor/transient-state-make-doc
         'symbol-highlight
         (format qingeditor/editor-ui-visual/symbol-highlight-state-doc
      ...
      (qingeditor/define-transient-state symbol-highlight
        ...
        :dynamic-hint (qingeditor/editor-ui-visual/symbol-highlight-ts-doc)
        :before-exit  (qingeditor/editor-ui-visual/ahs-ms-on-exit)
        :bindings
...
(defun qingeditor/editor-ui-visual/init-column-enforce-mode ()
...
(defun qingeditor/editor-ui-visual/init-hide-comnt ()
...
(defun qingeditor/editor-ui-visual/init-highlight-indentation ()
...
(defun qingeditor/editor-ui-visual/init-highlight-numbers ()
...
(defun qingeditor/editor-ui-visual/init-highlight-parenthesis ()
...
(defun qingeditor/editor-ui-visual/init-hl-anything ()
...
(defun qingeditor/editor-ui-visual/init-indent-guide ()
...
(defun qingeditor/editor-ui-visual/init-rainbow-delimiters ()
...
(defun qingeditor/editor-ui-visual/init-volatile-highlights ()
